...
export default function CtaSection() {
  return (
    <section className="no-orange-cursor w-full bg-[#f97316] py-20 px-6 sm:px-8 lg:px-12 border-t-2 border-[#1e1e28]">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
        ...
        <Link 
          href="/contact"
          className="bg-[#4b456f] text-white px-8 py-4 rounded-full font-extrabold text-sm tracking-wider uppercase border-2 border-[#1e1e28] shadow-[4px_4px_0px_0px_#ffffff] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_#ffffff] transition-all whitespace-nowrap"
        >
          Partner With Us
        </Link>
      </div>

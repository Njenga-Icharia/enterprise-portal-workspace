  ...
  return (
    <div className="relative w-full py-12 flex flex-col items-center">
      ...
      <div
        ...
        className="w-full flex gap-6 overflow-x-auto snap-x snap-mandatory px-8 pb-16 no-scrollbar"
        style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}
      >
        {items.map((item, index) => (
          <div
            key={item.id}
            // The alternating up/down logic is handled right here based on index
            className={`relative shrink-0 snap-start w-[300px] h-[400px] rounded-[20px] overflow-hidden group cursor-pointer transition-all duration-300 ${
